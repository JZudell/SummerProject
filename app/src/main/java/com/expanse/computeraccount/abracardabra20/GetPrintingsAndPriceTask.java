...
public class GetPrintingsAndPriceTask extends AsyncTask<String, Void, String> {
    int whichVersionToCall;
    long collectionIndex;

    private final String LOG_TAG = GetPrintingsAndPriceTask.class.getSimpleName();
    public GetPrintingsAndPriceTask(int whichVersionToCall,long collectionIndex) {
        this.whichVersionToCall = whichVersionToCall;
        this.collectionIndex = collectionIndex;
    }
    CallBackToMainListener mListener;

    public void setListener(CallBackToMainListener listener){
        mListener = listener;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
           ...
           // String baseUrl = "https://us-central1-tcginitiation.cloudfunctions.net/ANCIENTSECRETS?funactcode=5&cardName=";
            ...
            String uri = Uri.parse(baseUrl).buildUpon().appendQueryParameter("funactcode","5").appendQueryParameter("cardName",id).build().toString();
