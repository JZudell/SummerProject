...
public class ListAdapterDialogCollection extends ArrayAdapter<Card> {

    private ArrayList<Card> listOfCards;
    private Context context;
    public long collectionIndex;

    CallBackToCollectionDialog mListener;
    public void setListener(CallBackToCollectionDialog listener){
        mListener = listener;
    }

    public ListAdapterDialogCollection(Context context, int resource, ArrayList<Card> listOfCards,long collectionIndex){
...
//                alertadd.show();
                ...
                mListener.addCard(card,collectionIndex);
